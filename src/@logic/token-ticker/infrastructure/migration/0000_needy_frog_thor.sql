...
ALTER TABLE "tokens" ADD CONSTRAINT "tokens_logo_id_token_logos_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."token_logos"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
